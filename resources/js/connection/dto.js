export const dto = (() => {
     ...
     * @param {string|null} gif_url
     * @returns {{id: string, name: string, presence: boolean, comment: string|null, gif_id: string|null, gif_url: string|null}}
     */
    const postCommentRequest = (id, name, phone, address, comment) => {
        return {
            id,
            nama_tamu: name,
            no_hp: phone,

...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
          action: "TEMPLATE",
          text: "The Wedding of Irham and Agustina",
          dates: `${formatDate("2026-05-21 10:00")}/${formatDate("2026-05-21 11:00")}`,
          details:
            "Without disrespect, we invite you to attend our wedding. Thank you for your attention and blessings, which is a great joy and honor for us.",
          location:
            "Jl. Angkrek Situ No.19, Situ, Kec. Sumedang Utara, Kabupaten Sumedang, Jawa Barat 45621",
          ctz: config.get("tz"),
        });

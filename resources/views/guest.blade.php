...
<head>
    ...
    <title>Irham and Agustina's Online Wedding Invitation Website</title>
    ...
    <meta name="title" content="Website Undangan Pernikahan Irham dan Agustina Secara Online">
    <meta name="description" content="Website Undangan Pernikahan Irham dan Agustina Secara Online">
    ...
    <meta property="og:title" content="Website Undangan Pernikahan Irham dan Agustina Secara Online">
    <meta property="og:description" content="Website Undangan Pernikahan Irham dan Agustina Secara Online">
    ...
    <meta property="og:image" content="{{asset('assets/images/bg.png')}}">
    <meta property="og:image:secure_url" content="{{asset('assets/images/bg.png')}}">
    <meta property="og:image:type" content="image/png">
    <meta property="og:image:alt" content="Website Undangan Pernikahan Irham dan Agustina Secara Online">
    <meta property="og:image:width" content="980">
    <meta property="og:image:height" content="980">
    <meta property="og:type" content="website">
    <meta property="og:locale" content="id_ID">
    <meta property="og:url" content="https://ulems.my.id">
    <meta property="og:site_name" content="Website Undangan Pernikahan Irham dan Agustina Secara Online">

    <!-- Appearance -->
    <meta name="mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-title" content="Website Undangan Pernikahan Irham dan Agustina Secara Online">
    <meta name="theme-color" content="#000000">
    <meta name="color-scheme" content="dark light">
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    <link rel="canonical" href="https://ulems.my.id/">
    <link rel="icon" type="image/png" sizes="192x192" href="{{asset('assets/images/logo_wo.png')}}">
    <link rel="apple-touch-icon" sizes="192x192" href="{{asset('assets/images/logo_wo.png')}}">
...
<body data-key="local" data-url="{{ url('/api') }}/" data-audio="./assets/music/backsound.mp3" data-confetti="true" data-time="2026-05-21 10:00:00">
                ...
                <div class="d-flex position-absolute w-100 h-100">
                    <div class="position-relative overflow-hidden vw-100">
                        <div class="position-absolute h-100 w-100 slide-desktop" style="opacity: 0;">
                            <img src="{{ asset('assets/images/foto1.png') }}" data-src="{{ asset('assets/images/foto1.png') }}" alt="bg" class="bg-cover-home" style="mask-image: none; opacity: 30%;">
                        </div>
                        <div class="position-absolute h-100 w-100 slide-desktop" style="opacity: 0;">
                            <img src="{{ asset('assets/images/foto2.png') }}" data-src="{{ asset('assets/images/foto2.png') }}" alt="bg" class="bg-cover-home" style="mask-image: none; opacity: 30%;">
                        </div>
                        <div class="position-absolute h-100 w-100 slide-desktop" style="opacity: 0;">
                            <img src="{{ asset('assets/images/foto3.png') }}" data-src="{{ asset('assets/images/foto3.png') }}" alt="bg" class="bg-cover-home" style="mask-image: none; opacity: 30%;">
                        </div>
                    </div>
                </div>

                <div class="text-center p-4 bg-overlay-auto rounded-5">
                    <h2 class="font-esthetic mb-4" style="font-size: 2rem;">Irham &amp; Agustina</h2>
                    <p class="m-0" style="font-size: 1rem;">Thursday, May 21, 2026</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-7 col-md-6 col-lg-5 col-xl-4 col-xxl-3 m-0 p-0">
            ...
            <main data-bs-spy="scroll" data-bs-target="#navbar-menu" data-bs-root-margin="25% 0% 0% 0%" data-bs-smooth-scroll="true" tabindex="0">
                ...
                <section id="home" class="bg-light-dark position-relative overflow-hidden p-0 m-0">
                    <img src="{{ asset('assets/images/placeholder.webp') }}" data-src="{{asset('assets/images/bg.png')}}" alt="bg" class="position-absolute opacity-25 top-50 start-50 translate-middle bg-cover-home">

                    <div class="position-relative text-center bg-overlay-auto" style="background-color: unset;">
                        <h1 class="font-esthetic pt-5 pb-4 fw-medium" style="font-size: 2.25rem;">Wedding invitation</h1>

                        <img src="{{ asset('assets/images/placeholder.webp') }}" data-src="{{asset('assets/images/bg.png')}}" alt="bg" onclick="undangan.guest.modal(this)" class="img-center-crop rounded-circle border border-3 border-light shadow my-4 mx-auto cursor-pointer">

                        <h2 class="font-esthetic my-4" style="font-size: 2.25rem;">Irham &amp; Agustina</h2>
                        <p class="my-2" style="font-size: 1.25rem;">Thursday, May 21, 2026</p>
                ...
                <section class="bg-white-black text-center" id="bride">
                    ...
                    <p class="pb-4 px-2 m-0" style="font-size: 0.95rem;">Without diminishing respect, we invite you to grace our wedding ceremony:</p>
                    ...
                    <div class="overflow-x-hidden pb-4">
                        ...
                        <div class="position-relative">
                            ...
                            <div data-aos="fade-right" data-aos-duration="2000" class="pb-1">
                                <img src="{{ asset('assets/images/placeholder.webp') }}" data-src="{{ asset('assets/images/cowo.png') }}" alt="cowo" onclick="undangan.guest.modal(this)" class="img-center-crop rounded-circle border border-3 border-light shadow my-4 mx-auto cursor-pointer">
                                <h2 class="font-esthetic m-0" style="font-size: 2.125rem;">Irham Suparman Hidayat</h2>
                                <p class="mt-3 mb-1" style="font-size: 1.25rem;">1st son</p>
                                <p class="mb-0" style="font-size: 0.95rem;">Mr. Agum Renggi Al-Dzikry</p>
                                <p class="mb-0" style="font-size: 0.95rem;">and</p>
                                <p class="mb-0" style="font-size: 0.95rem;">Mrs. Nanda</p>
                            </div>
                        ...
                        <div class="position-relative">
                            ...
                            <div data-aos="fade-left" data-aos-duration="2000" class="pb-1">
                                <img src="{{ asset('assets/images/placeholder.webp') }}" data-src="{{asset('assets/images/cewe.png')}}" alt="cewe" onclick="undangan.guest.modal(this)" class="img-center-crop rounded-circle border border-3 border-light shadow my-4 mx-auto cursor-pointer">
                                <h2 class="font-esthetic m-0" style="font-size: 2.125rem;">Agustina</h2>
                                <p class="mt-3 mb-1" style="font-size: 1.25rem;">1st daughter</p>
                                <p class="mb-0" style="font-size: 0.95rem;">Mr. Rehan Febriana</p>
                                <p class="mb-0" style="font-size: 0.95rem;">and</p>
                                <p class="mb-0" style="font-size: 0.95rem;">Mrs. Riska Juliana</p>
                            </div>
                ...
                <section class="bg-light-dark pt-2 pb-4">
                    <div class="container text-center">
                        ...
                        <div class="bg-theme-auto mt-4 p-3 shadow rounded-4" data-aos="fade-down" data-aos-duration="2000">
                            <p class="p-1 mb-2" style="font-size: 0.95rem;">And all things We created in pairs, that you may remember (the greatness of Allah).</p>
                            <p class="m-0 p-0 text-theme-auto" style="font-size: 0.95rem;">QS. Adh-Dhariyat: 49</p>
                        </div>

                        <div class="bg-theme-auto mt-4 p-3 shadow rounded-4" data-aos="fade-down" data-aos-duration="2000">
                            <p class="p-1 mb-2" style="font-size: 0.95rem;">And indeed, it is Allah who creates pairs, both of the living and the dead,</p>
                ...
                <section class="bg-light-dark pt-2 pb-4">
                    <div class="container">
                        <div class="bg-theme-auto rounded-5 shadow p-3">
                            <h2 class="font-esthetic text-center py-2 mb-2" style="font-size: 2.125rem;">Love Story</h2>
                            <div id="video-love-stroy" class="position-relative rounded-4 mb-2 pb-0" data-src="{{ asset('assets/video/vd.mp4') }}" data-vid-class="w-100 rounded-4 shadow-sm m-0 p-0">
                                ...
                                <div class="overflow-y-scroll overflow-x-hidden p-2 with-scrollbar" style="height: 15rem;">
                                    <div class="row">
                                        ...
                                        <div class="col mt-1 mb-3 ps-0">
                                            <p class="fw-bold mb-2">💼 Simple First Meeting</p>
                                            <p class="small mb-0" style="text-align: justify;">
                                                In January 2025, Irham, a 28-year-old graphic designer, met Agustina, a smart and quiet copywriter, for a company branding project. Their interaction in the meeting room was limited to work matters, formal and professional. Unbeknownst to Irham, Agustina had actually seen Irham's design work in a national competition two years prior and was impressed by his talent. However, adhering to her principles, Agustina maintained distance and focused solely on the task at hand, avoiding unnecessary interactions.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col mt-1 mb-3 ps-0">
                                            <p class="fw-bold mb-2">💞 Seeds of Love in Testing</p>
                                            <p class="small mb-0" style="text-align: justify;">
                                                In February 2025, their project faced a crisis: the client rejected the initial concept and threatened to cancel the contract. Amid the pressure, Agustina stepped up with a creative solution that saved the project, leaving Irham impressed by her composure and intelligence. In secret, Irham began to pay more attention to Agustina, especially through her social media posts filled with faith and patience. Feeling a shared vision, Irham sought guidance and decided to initiate courtship. He contacted a trusted imam as an intermediary. The surprise came when Agustina admitted that she had been watching Irham for a long time too, but held back until there was a clear intention, a confession that warmed Irham's heart.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col mt-1 mb-3 ps-0">
                                            <p class="fw-bold mb-2">💍 Steps Towards Allah's Pleasure</p>
                                            <p class="small mb-0" style="text-align: justify;">
                                                The courtship process unfolded with complete sincerity, with a mentor ensuring each step was in accordance with Islamic principles. Irham and Agustina opened up to each other about their dream of building a family that would be blessed by Allah. However, a test came: Agustina's family was hesitant due to Irham's modest economic background. It was here that the plot twist revealed—Irham presented a social enterprise plan based on art that he had been developing in secret, showcasing his vision to benefit the community. This presentation melted Agustina's family's heart. In March 2025, after seeking guidance and receiving their blessing, Irham proposed to Agustina in a simple yet meaningful ceremony. With sincere intention, they took the next step towards marriage, confident that Allah had wove their story beautifully.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <section class="bg-white-black pb-2" id="wedding-date">
                    <div class="container text-center">
                        <h2 class="font-esthetic py-4 m-0" style="font-size: 2.25rem;">Happy Moment</h2>
                        ...
                        <div class="border rounded-pill shadow py-2 px-4 mt-2 mb-4">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-3 p-1">
                                    <p class="d-inline m-0 p-0" style="font-size: 1.25rem;" id="minute">0</p><small class="ms-1 me-0 my-0 p-0 d-inline">Minutes</small>
                                </div>
                                <div class="col-3 p-1">
                        ...
                        <p class="py-2 m-0" style="font-size: 0.95rem;">By asking for the grace and blessing of Allah Subhanahu Wa Ta'ala, God willing, we will hold the following event:</p>
                        ...
                        <div class="overflow-x-hidden">
                            <div class="py-2" data-aos="fade-right" data-aos-duration="1500">
                                <h2 class="font-esthetic m-0 py-2" style="font-size: 2rem;">Contract</h2>
                                <p style="font-size: 0.95rem;">10:00 AM - End</p>
                            </div>

                            <div class="py-2" data-aos="fade-left" data-aos-duration="1500">
                                <h2 class="font-esthetic m-0 py-2" style="font-size: 2rem;">Reception</h2>
                                <p style="font-size: 0.95rem;">11:00 AM - End</p>
                            </div>
                        </div>

                        <p class="py-2 m-0" style="font-size: 0.95rem;">For the sake of togetherness, we kindly request your presence and participation in the following dress code:</p>
                        ...
                        <div class="py-2" data-aos="fade-down" data-aos-duration="1500">
                            ...
                            <p style="font-size: 0.95rem;">Traditional attire and formal shoes.</p>
                        </div>

                        <div class="py-2" data-aos="fade-down" data-aos-duration="1500">
                            <a href="https://www.google.com/maps/place/SMK+Informatika+Sumedang/@-6.8841429,107.8754706,12z/data=!4m6!3m5!1s0x2e68d6cca33a73eb:0xafda24d08020430d!8m2!3d-6.8357591!4d107.9239744!16s%2Fg%2F1pzq46sg_?entry=ttu&g_ep=EgoyMDI2MDUwNi4wIKXMDSoASAFQAw%3D%3D" target="_blank" class="btn btn-outline-auto btn-sm rounded-pill shadow mb-2 px-3"><i class="fa-solid fa-map-location-dot me-2"></i>View Google Maps</a>
                            <small class="d-block my-1">Jl. Angkrek Situ No.19, Situ, Kecamatan Sumedang Utara, Kabupaten Sumedang, Jawa Barat.</small>
                        </div>
                        <div class="py-2" data-aos="fade-down" data-aos-duration="1500">
                            <a href="https://www.google.com/maps/place/SMK+Informatika+Sumedang/@-6.8841429,107.8754706,12z/data=!4m6!3m5!1s0x2e68d6cca33a73eb:0xafda24d08020430d!8m2!3d-6.8357591!4d107.9239744!16s%2Fg%2F1pzq46sg_?entry=ttu&g_ep=EgoyMDI2MDUwNi4wIKXMDSoASAFQAw%3D%3D" target="_blank" class="btn btn-outline-auto btn-sm rounded-pill shadow mb-2 px-3"><i></i>Reservasi</a>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container">
                        <div class="border rounded-5 shadow p-3">
                            ...
                            <div id="carousel-image-one" data-aos="fade-up" data-aos-duration="1500" class="carousel slide mt-4" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner rounded-4" style="max-height: 20rem;">
                                    <div class="carousel-item active">
                                        <img src="{{ asset('assets/images/foto4.png') }}" data-src="{{ asset('assets/images/foto4.png') }}"alt="image 1" class="d-block img-fluid cursor-pointer" onclick="undangan.guest.modal(this)">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{ asset('assets/images/foto2.png') }}" data-src="{{ asset('assets/images/foto2.png') }}" alt="image 2" class="d-block img-fluid cursor-pointer" onclick="undangan.guest.modal(this)">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{ asset('assets/images/foto3.png') }}" data-src="{{ asset('assets/images/foto3.png') }}" alt="image 3" class="d-block img-fluid cursor-pointer" onclick="undangan.guest.modal(this)">
                                    </div>
                                </div>
                            ...
                            <div id="carousel-image-two" data-aos="fade-up" data-aos-duration="1500" class="carousel slide mt-4" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner rounded-4" style="max-height: 20rem;">
                                    <div class="carousel-item active">
                                        <img src="{{ asset('assets/images/foto1.png') }}" data-src="{{ asset('assets/images/foto1.png') }}"alt="image 4" class="d-block img-fluid cursor-pointer" onclick="undangan.guest.modal(this)">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{ asset('assets/images/foto2.png') }}" data-src="{{ asset('assets/images/foto2.png') }}" alt="image 5" class="d-block img-fluid cursor-pointer" onclick="undangan.guest.modal(this)">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{ asset('assets/images/foto4.png') }}" data-src="{{ asset('assets/images/foto4.png') }}" alt="image 6" class="d-block img-fluid cursor-pointer" onclick="undangan.guest.modal(this)">
                                    </div>
                                </div>
                ...
                <section class="bg-light-dark pb-3">
                    <div class="container text-center">
                        ...
                        <p class="mb-1" style="font-size: 0.95rem;">With respect, for those of you who want to give us a token of love, you can do so via:</p>
                        ...
                        <div class="bg-theme-auto rounded-4 shadow p-3 mx-4 mt-4 text-start" data-aos="fade-up" data-aos-duration="2500">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-2">
                                <p class="m-0 p-0" style="font-size: 0.95rem;"><i class="fa-regular fa-user fa-sm me-1"></i>Irham Suparman</p>
                        ...
                        <div class="bg-theme-auto rounded-4 shadow p-3 mx-4 mt-4 text-start" data-aos="fade-up" data-aos-duration="2500">
                            ...
                            <div class="collapse" id="collapseQris">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('assets/images/placeholder.webp') }}" data-src="{{asset('assets/images/donate.png')}}" alt="donate" class="img-fluid rounded-3 mx-auto bg-white">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-theme-auto rounded-4 shadow p-3 mx-4 mt-4 text-start" data-aos="fade-up" data-aos-duration="2500">
                            ...
                            <div class="collapse" id="collapseGift">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="my-0 p-0 text-truncate me-2" style="font-size: 0.85rem;"><i class="fa-solid fa-location-dot me-1"></i>Jl. Angkrek Situ No.19, Situ, Kecamatan Sumedang Utara, Kabupaten Sumedang, Jawa Barat.</p>
                                    <!-- Ubah juga data-copy sesuai dengan alamat -->
                                    <button class="btn btn-outline-auto btn-sm shadow-sm rounded-4 py-0" style="font-size: 0.75rem;" data-copy="Jl. Angkrek Situ No.19, Situ, Kecamatan Sumedang Utara, Kabupaten Sumedang, Jawa Barat." onclick="undangan.util.copy(this)"><i class="fa-solid fa-copy"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="bg-light-dark my-0 pb-0 pt-3" id="comment">
                    <div class="container">
                        <div class="border rounded-5 shadow p-3 mb-2">
                            <h2 class="font-esthetic text-center mt-2 mb-4" style="font-size: 2.25rem;">Saying &amp; Prayers</h2>

                            <div class="mb-3">
                                <label for="form-name" class="form-label my-1"><i class="fa-solid fa-person me-2"></i>Name</label>
                                <input dir="auto" type="text" class="form-control shadow-sm rounded-4" id="form-name" minlength="2" maxlength="50" placeholder="Enter your name" autocomplete="name" data-offline-disabled="false">
                            </div>

                            <div class="mb-3">
                                <label for="form-phone" class="form-label my-1">
                            ...
                            <div class="mb-3">
                                <label for="form-address" class="form-label my-1">
                            ...
                            <div class="mb-3">
                                <label for="form-presence" class="form-label my-1"><i class="fa-solid fa-person-circle-question me-2"></i>Presence</label>
                            ...
                            <div class="d-block mb-3" id="comment-form-default">
                                <label for="form-comment" class="form-label my-1"><i class="fa-solid fa-comment me-2"></i>Saying &amp; prayer</label>
                                <div class="position-relative">
                                    ...
                                    <textarea dir="auto" class="form-control shadow-sm rounded-4" id="form-comment" rows="4" minlength="1" maxlength="1000" placeholder="Write Your Messages and Prayers" autocomplete="off" data-offline-disabled="false"></textarea>
                                </div>
                            </div>
                ...
                <section class="bg-white-black py-2 no-gap-bottom">
                    <div class="container text-center">
                        ...
                        <div class="row align-items-center justify-content-between flex-column pb-3">
                            <div class="col-auto">
                                <small>Build with<i class="fa-solid fa-heart mx-1"></i>Team B</small>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <ul class="navbar-nav nav-justified w-100 align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#bride">
                            ...
                            <span class="d-block" style="font-size: 0.7rem;">Bride & Groom</span>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#comment">
                            ...
                            <span class="d-block" style="font-size: 0.7rem;">Comments</span>
                        </a>
                    </li>
                </ul>
            </nav>
    ...
    <div class="loading-page bg-white-black" id="welcome" style="opacity: 0;">
        <div class="d-flex justify-content-center align-items-center vh-100 overflow-y-auto">
            <div class="d-flex flex-column text-center">
                ...
                <img src="{{ asset('assets/images/placeholder.webp') }}" data-src="{{ asset('assets/images/bg.png') }}" alt="background" class="img-center-crop rounded-circle border border-3 border-light shadow mb-4 mx-auto">

                <h2 class="font-esthetic mb-4" style="font-size: 2.25rem;">Irham &amp; Agustina</h2>
                <div id="guest-name" data-message="To Dear Sir/Madam/Brother/Sister"></div>
    ...
    <div class="loading-page bg-white-black" id="loading" style="opacity: 1;">
        <div class="d-flex justify-content-center align-items-center vh-100 overflow-y-auto">
            <div class="d-flex flex-column width-loading text-center">
                <img src="{{ asset('assets/images/placeholder.webp') }}" data-src="{{ asset('assets/images/logo_wo.png') }}" fetchpriority="high" class="img-fluid mb-3 mx-auto object-fit-cover opacity-0" alt="icon" style="width: 3.5rem; height: 3.5rem;">
            ...
            <div class="modal-content rounded-4 border border-0">
                <div class="modal-body p-0">
                    <div class="d-flex position-absolute top-0 end-0">
                        <a class="btn d-flex justify-content-center align-items-center bg-overlay-auto p-2 m-1 rounded-circle border shadow-sm z-1" role="button" target="_blank" href="{{asset('assets/images/placeholder.webp')}}" id="button-modal-click">
                    ...
                    <img src="{{ asset('assets/images/placeholder.webp') }}" class="img-fluid w-100 rounded-4 cursor-pointer" alt="image" id="show-modal-image">
                </div>
            </div>
        </div>
    </div>
